...
def train(hyp, opt, device, tb_writer=None):
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        logger.info(('\n' + '%10s' * 9) % ('Epoch', 'gpu_mem', 'box', 'obj', 'cls', 'ang', 'total', 'targets', 'img_size'))
        if rank in [-1, 0]:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='dotabest.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='yolov5s.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/VOCdota.yaml', help='data.yaml path')
